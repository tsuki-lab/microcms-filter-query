...
describe("`equals`メソッドの動作テスト", () => {
  it("gender[equals]women", () => {
    const result = new MicroCMSFilterQuery().equals('gender', 'women').$execute()
...
describe("`notEquals`メソッドの動作テスト", () => {
  it("gender[not_equals]women", () => {
    const result = new MicroCMSFilterQuery().notEquals('gender', 'women').$execute()
...
describe("`lessThan`メソッドの動作テスト", () => {
  it("createdAt[less_than]2019-11", () => {
    const result = new MicroCMSFilterQuery().lessThan('createdAt', '2019-11').$execute()
...
describe("`greaterThan`メソッドの動作テスト", () => {
  it("createdAt[greater_than]2019-10", () => {
    const result = new MicroCMSFilterQuery().greaterThan('createdAt', '2019-10').$execute()
...
describe("`contains`メソッドの動作テスト", () => {
  it("title[contains]おすすめ", () => {
    const result = new MicroCMSFilterQuery().contains('title', 'おすすめ').$execute()
...
describe("`beginsWith`メソッドの動作テスト", () => {
  it("publishedAt[begins_with]2019-11", () => {
    const result = new MicroCMSFilterQuery().beginsWith('publishedAt', '2019-11').$execute()
